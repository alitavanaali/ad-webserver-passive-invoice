...
bp = Blueprint('passiveinvoice', __name__,
...
def upload():
    ...
    return make_response(render_template('upload-passiveinvoice.html'), 200, headers)
...
def async_uploader():
    ...
    if f != None:
        ...
        if any(ext in f.filename.lower() for ext in [".pdf", ".jpg", ".png", ".jpeg", ".docx", ".doc"]):
...
app.register_blueprint(bp, url_prefix='/activedocuments/passiveinvoice')